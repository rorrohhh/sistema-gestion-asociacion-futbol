...
function ClubesTable() {
    ...
    const [generatingPdf, setGeneratingPdf] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // Para mostrar loading en el botón específico
    ...
    const handleDelete = async (id, nombre)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].deleteClub(id.toString());
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Club "${nombre}" eliminado exitosamente.`);
            fetchClubes();
        } catch (error) {
    ...
    const handleGeneratePDF = async (clubId, clubNombre)=>{
        ...
        try {
            ...
            const jugadores = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getJugadores({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2392c0e2._.js.map