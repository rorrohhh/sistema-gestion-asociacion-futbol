...
function NuevoJugadorPage() {
    ...
    const onSubmit = async (data_0)=>{
        ...
        try {
            const dataToSend = {
                ...data_0,
                numero: data_0.numero,
                paterno: data_0.paterno,
                materno: data_0.materno,
                nombres: data_0.nombres,
                rol: data_0.rol_input,
                rut: data_0.run_input
            };
...
_s(NuevoJugadorPage, "RMtk19yZy4WCRyJOEzcm0pPrFGU=", false, function() {
    return [
...
//# sourceMappingURL=_2c2e053c._.js.map