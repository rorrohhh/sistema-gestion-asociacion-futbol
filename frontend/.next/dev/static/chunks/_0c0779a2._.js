...
function TorneoDashboard() {
    ...
    const handleUpdateScore = async (id)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Resultado actualizado");
    ...
    partidosDeLaFecha.forEach((p_1)=>{
        ...
        const key = `${p_1.local.id}-${p_1.visita.id}`;
...
//# sourceMappingURL=_0c0779a2._.js.map